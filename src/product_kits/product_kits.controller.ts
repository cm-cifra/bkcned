import { Body, Controller, Delete, Get, HttpStatus, Param, Post, Put,BadRequestException, Res } from "@nestjs/common";
...
export class ProductKitsController {
  ...
  @Post("bulk")
    async createBulk(@Body() createUserOto: ProductKitsEntity[]) {
      try {
