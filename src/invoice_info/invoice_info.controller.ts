...
@Controller('invoice-info')
export class InvoiceInfoController {
    constructor(private i_service: InvoiceInfoService) {
    ...
    @Post('add')
    async addItem(@Body() createUserOto: InvoiceInfoEntity) {
