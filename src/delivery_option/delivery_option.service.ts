...
import { DeliveryEntity } from './delivery_option.entity';

@Injectable()
export class DeliveryOptionService {
    constructor(
        @InjectRepository(DeliveryEntity)
        private readonly i_repository: Repository<DeliveryEntity>,
    ...
    async addItem(user: DeliveryEntity): Promise<DeliveryEntity> {
