...
@Controller('info_shower_systems')
export class InfoShowerSystemsController {
    ...
    @Post('add')
    async addItem(@Body() createUserOto: InfoShowerSystemsEntity){
    ...
    @Post("bulk")
    async createBulk(@Body() createUserOto: InfoShowerSystemsEntity[]) {
      try {
